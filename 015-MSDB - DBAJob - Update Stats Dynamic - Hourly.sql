...
/****** Object:  Job [DBAJob: Update Stats Dynamic - Hourly]    Script Date: 01/05/2011 14:05:23 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[DBAJobs]]]    Script Date: 01/05/2011 14:05:24 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBAJob: Update Stats Dynamic - Hourly', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [UpdateStats_Alldbs]    Script Date: 01/05/2011 14:05:25 ******/
...
', 
		...
		@output_file_name=N'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\LOG\Update Stats Dynamic - Hourly.txt', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Release Cache]    Script Date: 01/05/2011 14:05:25 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'hourly', 
		...
		@schedule_uid=N'3fd25a4b-9823-4b1c-89e3-6aa28c411c6a'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
